 ...
 * Use the [FragmentLanding3.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentLanding3 : Fragment(), FragmentLanding3Presenter.Listener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val presenter = FragmentLanding3Presenter(this)
